        ...
        headers: [
{
  ...
  value: [
    "default-src 'self'",
    "script-src 'self' 'unsafe-eval' 'unsafe-inline' https://cdn.shopify.com https://shop.app",
    ...
    "font-src 'self' data:",
    "connect-src 'self' https://*.myshopify.com https://cdn.shopify.com https://shop.app https://*.shopifycloud.com https://*.shopifysvc.com",
    "frame-src 'self' https://*.myshopify.com https://shop.app https://*.shopifycloud.com",
