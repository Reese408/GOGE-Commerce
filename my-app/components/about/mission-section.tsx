...
function MissionCard({ icon, title, description, delay }: MissionCardProps) {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="bg-white dark:bg-zinc-900 rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300"
    >
      <div className="w-14 h-14 rounded-full bg-gradient-to-br from-[#927194] to-[#D08F90] flex items-center justify-center mb-6 text-white">
        {icon}
      </div>
